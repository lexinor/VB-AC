--
-- VB-AC Remastered v1.0 by VisiBait (VB-SCRIPTS)
--
...
if VB_AC.Enable then
        ...
        while true do
            ...
            if VB_AC.AntiExplosiveBullets then
                ...
                if _weapondamage == 4 or _weapondamage == 5 or _weapondamage == 6 or _weapondamage == 13 then
                    sendinfotoserver("Ue53dCG6hctHvrOaJB5Q", "explosiveweapon") -- BAN (EXPLOSIVE WEAPON)
                end
                _Wait(400)
            end
            ...
            if VB_AC.AntiGiveArmor then
                ...
                if _armor > 100 then
                    sendinfotoserver("Ue53dCG6hctHvrOaJB5Q", "givearmour") -- BAN (ARMOR)
                end
                _Wait(400)
            end
            if VB_AC == nil then
    ...
    Citizen.CreateThread(function()
        while VB_AC.AntiVehicleModifiers do
            ...
            if IsPedInAnyVehicle(_ped, false) then
                ...
                if IsVehicleDamaged(_vehiclein) and GetEntityHealth(_vehiclein) >= GetEntityMaxHealth(_vehiclein) then
                ...
                if IsPedInAnyVehicle(_ped, false) then -- Checks again just in case..
                    ...
                    elseif tonumber(_neoncolor2) ~= tonumber(_newneoncolor2) then
                        sendinfotoserver("Ue53dCG6hctHvrOaJB5Q", "vehiclemodifier", "11") -- BAN (VEHICLE MODIFIER(TYPE: 11))
                    elseif tonumber(_neoncolor3) ~= tonumber(_newneoncolor3) then
                        sendinfotoserver("Ue53dCG6hctHvrOaJB5Q", "vehiclemodifier", "12") -- BAN (VEHICLE MODIFIER(TYPE: 12))
                    end
                end
    ...
    AddEventHandler("gameEventTriggered", function(name, args)
        ...
        if VB_AC.AntiSuicide then
            if name == 'CEventNetworkEntityDamage' and args[2] == -1 and args[5] == tonumber(-842959696) then
