--[[ 
	...
	Anticheat updates don't require to download other files, because, when the anticheat is updated, it automatically loads the new files into your server.
...
VB_AC.LogBanWebhook = ""
VB_AC.ModelsLogWebhook = ""
VB_AC.ExplosionLogWebhook = ""
...
VB_AC.BlacklistedModels = { -- Solo peds o vehículos
	"skylift",
	"valkyrie2",
	"airbus",
	"hunter",
